activity = readtable('Y:\Olena Bukalo\AS project\AS data\neurons\neurons 1p\final\E-Ext_activity_HB.xlsx');
[~, header] = xlsread('Y:\Olena Bukalo\AS project\AS data\neurons\neurons 1p\final\E-Ext_activity_HB.xlsx');
cells = str2double(header(:,3:end));

group_info = readtable('Y:\Olena Bukalo\AS project\AS data\neurons\neurons 1p\final\E-Ext CS_responsivity.xlsx','Sheet','auc_diff_obs');

freezing_folder = 'D:\AS-Gq-hSyn-GRIN\CNO-VEH_extinction\FreezingOutput_processed';
freeze_threshold = 30;
move_threshold = 30;
FPS = 30;
