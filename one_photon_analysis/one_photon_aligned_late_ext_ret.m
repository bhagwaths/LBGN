activity = readtable('Z:\Hrishikesh Bhagwat\Late E-Ret_activity_HB.xlsx');
[~, header] = xlsread('Z:\Hrishikesh Bhagwat\Late E-Ret_activity_HB.xlsx');
cells = str2double(header(:,3:end));

group_info = readtable('Z:\Olena Bukalo\AS project\AS data\neurons\neurons 1p\final\Late E-Ret CS_responsivity.xlsx','Sheet','auc_diff_obs');

freezing_folder = 'E:\AS-Gq-hSyn-GRIN\late_extinction_retrieval\FreezingOutput_processed';
freeze_threshold = 30;
move_threshold = 30;
FPS = 30;
...
animalNames = {
    ...
    'AS-Gq-hSyn-GRIN-7';
    'AS-Gq-hSyn-GRIN-8';
    % 'AS-Gq-hSyn-GRIN-9'; % not in Late E-Ret CS_responsivity.xlsx
    % 'AS-Gq-hSyn-GRIN-11'; % not in Late E-Ret CS_responsivity.xlsx
    'AS-Gq-hSyn-GRIN-12';
    'AS-Gq-hSyn-GRIN-13';
    'AS-Gq-hSyn-GRIN-14';
    'AS-Gq-hSyn-GRIN-15';
...
groups = {'VEH-CNO'; % 5
            ...
            'CNO-VEH'; % 7
            'VEH-CNO'; % 8
            % 'VEH-CNO'; % 9 - not in Late E-Ret CS_responsivity.xlsx
            % 'VEH-VEH'; % 11 - not in Late E-Ret CS_responsivity.xlsx
            'CNO-VEH'; % 12
            'VEH-CNO'; % 13
            'VEH-VEH'; % 14
            'VEH-CNO'; % 15
