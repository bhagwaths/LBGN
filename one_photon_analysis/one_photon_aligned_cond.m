activity = readtable('C:\Users\bhagwaths\Documents\F-Con_CS_activity_HB.xlsx');
[~, header] = xlsread('C:\Users\bhagwaths\Documents\F-Con_CS_activity_HB.xlsx');
cells = str2double(header(:,3:end));

group_info = readtable('Z:\Olena Bukalo\AS project\AS data\neurons\neurons 1p\final\F-Con CS_responsivity.xlsx','Sheet','auc_diff_obs');

freezing_folder = 'E:\AS-Gq-hSyn-GRIN\conditioning\FreezingOutput_processed';
freeze_threshold = 30;
move_threshold = 30;
FPS = 30;
...
animalNames = {
    ...
    'AS-Gq-hSyn-GRIN-7';
    'AS-Gq-hSyn-GRIN-8';
    % 'AS-Gq-hSyn-GRIN-9'; % not in F-Con CS_responsivity.xlsx
    'AS-Gq-hSyn-GRIN-11';
    'AS-Gq-hSyn-GRIN-12';
    'AS-Gq-hSyn-GRIN-13';
    'AS-Gq-hSyn-GRIN-14';
...
groups = {'VEH-CNO'; % 5
            ...
            'CNO-VEH'; % 7
            'VEH-CNO'; % 8
            % 'VEH-CNO'; % 9 - not in F-Con CS_responsivity.xlsx
            'VEH-VEH'; % 11
            'CNO-VEH'; % 12
            'VEH-CNO'; % 13
            'VEH-VEH'; % 14
