activity = readtable('Z:\Hrishikesh Bhagwat\F-Ren_activity_HB.xlsx');
[~, header] = xlsread('Z:\Hrishikesh Bhagwat\F-Ren_activity_HB.xlsx');
cells = str2double(header(:,3:end));

group_info = readtable('Z:\Olena Bukalo\AS project\AS data\neurons\neurons 1p\final\F-Ren CS_responsivity.xlsx','Sheet','auc_diff_obs');

freezing_folder = 'E:\AS-Gq-hSyn-GRIN\fear_renewal\FreezingOutput_processed';
freeze_threshold = 30;
move_threshold = 30;
FPS = 30;
